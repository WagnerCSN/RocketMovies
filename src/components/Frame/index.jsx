...
export function Frame({data, ...rest}){
    return(
        <Container {...rest}>
            ...
            <main>
                <p>Pragas nas colheitas fizeram a civilização humana regredir para uma sociedade agrária em futuro de 
                    ...
                    mensagens codificadas através de radiação gravitacional, deixando coordenadas em binário que os levam
                     ...
                     buraco de minhoca foi aberto perto de Saturno e que ele leva a planetas que podem oferecer condições
                      ...
                      a humanidade irá seguir para ele na instalação da NASA, que é na realidade uma enorme estação 
